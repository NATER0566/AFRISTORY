const Ads = (() => {
  ...
  function createPayload() { return { provider: 'rewarded-demo', completedAt: new Date().toISOString(), nonce: crypto.randomUUID?.() || `${Date.now()}-${Math.random()}` }; }
  ...
  return { refresh, showRewarded, get remaining() { return remaining; } };
})();
